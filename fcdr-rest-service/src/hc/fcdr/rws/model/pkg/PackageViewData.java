...
public class PackageViewData {
	...
	public PackageViewData() {
		...
		this.package_country = null;
		this.package_size = null;
		this.package_size_unit_of_measure = null;
		this.storage_type = null;
		this.storage_statements = null;
		this.health_claims =null;
		this.other_package_statements = null;
		this.suggested_directions = null;
		this.ingredients = null;
		this.multi_part_flag = null;
		this.nutrition_fact_table = null;
		this.as_prepared_per_serving_amount = null;
		this.as_prepared_unit_of_measure = null;
		this.as_sold_per_serving_amount = null;
		this.as_sold_unit_of_measure = null;
		this.as_prepared_per_serving_amount_in_grams = null;
		this.as_sold_per_serving_amount_in_grams = null;
		this.package_comment = null;
		this.package_source = null;
		this.package_product_description = null;
	...
	public PackageViewData(Integer package_id, Integer product_id, String package_description, String package_upc,
			String package_brand, String package_manufacturer, String package_country, Double package_size,
			...
			String nft_last_update_date, Double product_grouping, Boolean child_item, Double classification_number,
			String classification_name, Double nielsen_item_rank, String nutrient_claims,
			String package_nielsen_category, String common_household_measure, String creation_date,
			String last_edit_date, Boolean calculated) {
		super();
	...
	public void setNft_last_update_date(String nft_last_update_date) {
		this.nft_last_update_date = nft_last_update_date;
	}
	...
	public void setNielsen_item_rank(Double nielsen_item_rank) {
		this.nielsen_item_rank = nielsen_item_rank;
	}
