...
public class SalesDao extends PgDao
{
    private static final Logger logger       =
            Logger.getLogger(SalesDao.class.getName());
    ...
    public Sales getSales(final Long salesId) throws DaoException
    {
        ...
        final String query =
                "select * from " + schema + "." + "sales where sales_id = ?";
    ...
    public Integer checkBySalesUpc(final String salesUpc) throws DaoException
    {
        ...
        final String query =
                "select sales_product_id_fkey from "
                        + schema + "." + "sales where sales_upc = ?";
    ...
    public Integer insert(final List<Object> csvFieldList) throws DaoException
    {
        ...
        {
                "sales_upc", "sales_description", "sales_brand",
                "sales_manufacturer", "dollar_rank", "dollar_volume",
                "dollar_share", "dollar_volume_percentage_change",
                "kilo_volume", "kilo_share", "kilo_volume_percentage_change",
                "average_ac_dist", "average_retail_price", "sales_source",
                "nielsen_category", "sales_collection_date", "sales_year",
                "control_label_flag", "kilo_volume_total", "kilo_volume_rank",
                "dollar_volume_total", "cluster_number", "product_grouping",
        ...
        String query =
                SQL_INSERT.replaceFirst(TABLE_REGEX, schema + "." + "sales");
            ...
            final SalesInsertRequest salesInsertRequest) throws DaoException
    {
        final Map<String, Object> queryMap =
                DaoUtil.getQueryMap(salesInsertRequest);
        ...
        final String[] columns =
        {
                "sales_description", "sales_upc", "sales_brand",
                "sales_manufacturer", "dollar_rank", "dollar_volume",
                "dollar_share", "dollar_volume_percentage_change",
                "kilo_volume", "kilo_share", "kilo_volume_percentage_change",
                "average_ac_dist", "average_retail_price", "sales_source",
                "nielsen_category", "sales_year", "control_label_flag",
                "kilo_volume_total", "kilo_volume_rank", "dollar_volume_total",
                "cluster_number", "product_grouping",
                "sales_product_description", "classification_number",
                "classification_type", "sales_comment", "sales_collection_date",
                "number_of_units", "edited_by", "creation_date",
                "last_edit_date", "sales_product_id_fkey" };
        ...
        final List<Object> salesInsertList =
                (List<Object>) queryMap.get("sales_insert_list");
    ...
    {
        final Map<String, Object> queryMap =
                DaoUtil.getQueryMap(salesUpdateRequest);
        ...
        final String[] columns =
        {
                ...
                "sales_product_description", "classification_number",
                "classification_type", "sales_comment", "sales_collection_date",
                "number_of_units", "edited_by", "last_edit_date", "sales_id" };
        ...
        final List<Object> salesUpdateList =
                (List<Object>) queryMap.get("sales_update_list");
            ...
            throws SQLException, IOException, Exception
    {
        ...
        final String query =
                "select distinct sales_year from "
                        + schema + "." + "sales order by sales_year asc";
            ...
            throws SQLException, IOException, Exception
    {
        ...
        String query_count =
                "select count(*) AS COUNT from " + schema + "." + "sales";
        ...
        if (a && b)
            ...
            else
            {
                ...
                where_clause_count +=
                        " AND sales_collection_date BETWEEN ? AND ? ";
